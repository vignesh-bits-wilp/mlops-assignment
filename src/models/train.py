...
# MLflow setup - keeping it simple for now
...
try:
    ...
    # Experiment already exists, no worries
    pass
...
def train_models():
    ...
    # Define model candidates - started with just linear regression,
    # but decided to add decision tree for comparison
    candidates = {
